...
const REGISTERS = {
    ...
    total_inverter_power: { address: 35138, words: 2, dataType: 'int32',     name: 'Gesamtleistung WR',            group: 'grid', unit: 'W',   role: 'value.power' },
    ...
    operation_mode: {
        address: 35188, dataType: 'uint16', name: 'EMS Modus', group: 'settings', role: 'value', writable: true,
        states: { 0: 'General Mode', 1: 'Off Grid', 2: 'Backup Mode', 3: 'Eco Mode', 4: 'Eco Charge', 5: 'Eco Discharge' },
        type: 'string',
    },
